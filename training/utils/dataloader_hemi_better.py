...
class Dataset_2D_hemi_Train(Dataset):
    def __init__(
        ...
        self.masks = list()
        ##装载数据
        data_list = ['eb-inner-groundtruth-with-context-x20172-y2322-z14332.zarr','eb-outer-groundtruth-with-context-x20532-y3512-z14332.zarr',
            'fb-inner-groundtruth-with-context-x17342-y4052-z14332.zarr','fb-outer-groundtruth-with-context-x13542-y2462-z14332.zarr',
            'lh-groundtruth-with-context-x7737-y20781-z12444.zarr','lobula-groundtruth-with-context-x3648-y12800-z29056.zarr',
            'pb-groundtruth-with-context-x8472-y2372-z9372.zarr','pb-groundtruth-with-context-x8472-y2892-z9372.zarr']
        ...
        for data_name in data_list:
            ...
            labels = labels[128:int(labels.shape[0]-128),128:int(labels.shape[1]-128), 128:int(labels.shape[2]-128)]
...
class Dataset_3D_hemi_Train(Dataset):
    def __init__(
        ...
        # ##Debug
        # data_list = ['eb-inner-groundtruth-with-context-x20172-y2322-z14332.zarr']
